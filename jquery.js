 ...
 */
/*!
 * jQuery Clone.js 1.0.0
 * https://gist.github.com/sunny00217wm/aaf05b57c1171bf3b14209c78cc38e34
 *
...
( function() {
    ...
    window.console.log( "jQuery: jQuery is installed, version " + version );
} )();
...
function nodeName( elem, name ) {
    return name ? ( elem.nodeName  && elem.nodeName.toLowerCase() === name.toLowerCase() ) : elem.nodeName;
};
...
jQuery.InstallExtensionLog('jQuery.cookie', 'https://github.com/carhartl/jquery-cookie', '1.4.1' );
...
jQuery.InstallExtensionLog('jQuery.clone', 'https://gist.github.com/sunny00217wm/aaf05b57c1171bf3b14209c78cc38e34', '1.0.0');

var oldClone = typeof jQuery.clone == 'function' ? jQuery.clone : function ( elem, dataAndEvents, deepDataAndEvents ) {
    return jQuery( elem ).clone( deepDataAndEvents || dataAndEvents ).get( 0 );
};
...
jQuery.clone = function () {
    ...
    if ( args[ 0 ] instanceof jQuery.fn.init ) {
        ...
        args[ 0 ].each( function ( i, value ) {
            ret[i] = jQuery.clone( value );
        } );
        return jQuery( ret );
    } else if ( args[ 0 ] instanceof Element ) {
        return oldClone.apply( {}, args );
    } else if ( args[ 0 ] === null || args[ 0 ] === undefined ) {
            return args[ 0 ];
    } else {
        var navobjlist = [ Boolean, Number, Function, Date, RegExp, Error, Symbol/*, Array, Object*/ ];
        jQuery.each( navobjlist, function (_i, value) {
            if ( args[ 0 ] instanceof value ) {
                ret = value( args[ 0 ] );
            }
        } );
        return ret || jQuery.extend( Array.isArray( args[ 0 ] ) ? [] : {}, args[ 0 ] );
    } 
};
...
jQuery.InstallExtensionLog('jQuery.validate', 'https://jqueryvalidation.org/validate/', '1.19.3' );
